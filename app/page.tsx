...
const CONFIG = {
  ...
  "backend_url": "https://sqtqkpjsui.execute-api.us-east-2.amazonaws.com/dev/inference"
}
    ...
    <div className="flex min-h-screen flex-col items-center justify-center py-2">
      <main className="flex w-full flex-1 flex-col items-center justify-center px-20 text-center">
        <h1 className="text-6xl font-bold">
          ImageNet Inference on {' '}
          <a className="text-blue-600" href="https://nextjs.org">
            Serverless
          </a>
        </h1>
        <div className="mt-10 text-lg">
          Select a JPEG Image that belongs to Imagenet Classes 
        </div>
        <div className='mt-10 flex flex-row space-x-5 text-xl'>
          <div>
            <input className="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" accept='image/jpeg' onChange={(e) => {
      ...
      <footer className="flex h-24 w-full items-center justify-center border-t">
        <a
          ...
          href="www.linkedin.com/in/anilkumar-n-bhatt"
          target="_blank"
          rel="noopener noreferrer"
        >
          AWS Serverless 🤖 Anil Bhatt
        </a>
      </footer>
    </div>
  )
